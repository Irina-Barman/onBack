...
### 4. Миграции (Alembic)
При первом запуске:
Инициализация базы данных: ```bash docker compose exec api flask db init```
...
4. Создание миграций: ```bash docker compose exec api flask db migrate -m "Добавление миграций"```
