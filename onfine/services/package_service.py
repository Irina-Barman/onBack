        ...
        result.append(
            {
                ...
                "popular": p.popular,  # Новое поле популярности
                ...
                "target_audience": prop.target_audience.value if prop and prop.target_audience else None,  # noqa: E501
            },
        )
    return result
        ...
        result.append(
            {
                ...
                "interest_rate_to": str(prop.interest_rate_to) if prop else None,
                "bonuses": prop.bonuses if prop else None,
                "target_audience": prop.target_audience.value if prop and prop.target_audience else None,
            },
        )
    return result
