...
account_info = ns.model("AccountInfo", {
...
total_count = ns.model("TotalCount", {
...
total_hashrate = ns.model("TotalHashrate", {
...
worker_detail = ns.model("WorkerDetail", {
...
workers_info = ns.model("WorkersInfo", {
...
income_entry = ns.model("IncomeEntry", {
...
income_info = ns.model("IncomeInfo", {
    "income": fields.List(fields.Nested(income_entry), required=True),
})

payout_entry = ns.model("PayoutEntry", {
...
payouts_info = ns.model("PayoutsInfo", {
