...
class ResendConfirmation(Resource):
    ...
    def post(self) -> Tuple[Dict[str, Any], int]:
        ...
        return {"message": "If the email exists, confirmation email has been sent."}, 200
...
class ConfirmEmail(Resource):
    ...
    def get(self):  # noqa ANN201
        ...
        Example request:
            curl -X GET "http://127.0.0.1:5500/api/auth/confirm-email?token=your-confirmation-token"
        """
...
class UserMe(Resource):
    ...
    def get(self) -> Dict[str, Any]:
        ...
        Example request:
            curl -X GET "http://127.0.0.1:5500/api/auth/user" \
