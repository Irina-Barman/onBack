...
class DataCoinInfo(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    account_info_id = db.Column(db.Integer, db.ForeignKey("emcd_account_info.id"), nullable=False)
    ...
    __table_args__ = (
        db.UniqueConstraint("account_info_id", "coin_id", "date", name="uq_emcd_coin_account_coin_date"),
        Index("idx_coin_account_coin_date", "account_info_id", "coin_id", "date"),
