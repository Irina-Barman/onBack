...
class BlockchainTokens(db.Model):
    ...
    decimals = db.Column(db.Integer, nullable=False, default=18, comment="Количество десятичных знаков")
    ...
    is_active = db.Column(db.Boolean, default=True, comment="Флаг активности токена для фильтрации")
    ...
    def __repr__(self) -> str:
        ...
        """
        return f"<BlockchainToken network={self.network} symbol={self.symbol} " f"native_gas={self.is_native_gas}>"
