...
packages_property: Dict[str, PackagePropertyData] = {
    "Mini": {
        ...
        "bonuses": "Access to basic analytics",
    ...
    "Standard": {
        ...
        "bonuses": "+ webinars for beginners",
    ...
    "Business": {
        ...
        "bonuses": "Consultations with CEO",
        "target_audience": PackageCategory.MAXIMUM_EARNING,
    },
    "VIP": {
        "term_months": 24,
        ...
        "bonuses": "Participation in the company's profits",
